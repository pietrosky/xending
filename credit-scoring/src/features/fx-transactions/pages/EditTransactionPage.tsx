...
export function EditTransactionPage() {
  ...
  function handleSubmit(input: CreateTransactionInput) {
    ...
    updateMutation.mutate(
      { id, updates: { buys_usd: input.buys_usd, base_rate: input.base_rate, markup_rate: input.markup_rate, exchange_rate: input.exchange_rate, payment_account_id: input.payment_account_id, pi_account_id: input.pi_account_id, buys_currency: input.buys_currency, pays_currency: input.pays_currency } },
